package com.store.servlet.listeners;
...
import com.store.util.DBConnectionManager;
...
public class AppContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
    	...
    	try {
			DBConnectionManager connectionManager = new DBConnectionManager(dbURL, user, pwd);//, user, pwd
